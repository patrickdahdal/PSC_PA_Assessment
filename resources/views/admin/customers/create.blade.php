        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="col-sm-6 form-group">
                    ...
                    {!! Form::text('membercode', old('membercode'), ['class' => 'form-control', 'placeholder' => '']) !!}
            ...
            <div class="row">
                <div class="col-sm-12 form-group">
                    <br>
                    {!! Form::submit(trans('global.app.save'), ['class' => 'btn btn-success']) !!} &nbsp;
                    <a href="{{ route('admin.customers.index') }}" class="btn btn-default">@lang('global.app.cancel')</a>
                </div>
            </div>
